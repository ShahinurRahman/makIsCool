        ...
        columns: [
            {
                ...
                renderer: function (v, p, record) {
                    ...
                    if (editUserFeature = "editUser") {
                        renderText = renderText + " <a href='editUser.cool?id=" + record.get('id') + "'><img title='Edit' src='../resources/images/edit.png'/></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                    }

                    if (deleteUserFeature = "deleteUser") {
                        renderText = renderText + " <a href='deleteUser.cool?id=" + record.get('id') + "'><img title='Delete' src='../resources/images/delete.png'/></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                    }
                    return renderText;
                }
