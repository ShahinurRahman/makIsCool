...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                <i class="fa fa-dashboard"></i> <a href="../home.cool">Dashboard</a>
            </li>
...
<div class="row">
    <div class="col-lg-6 text-center">
        <form name="dataForm" id="dataForm" action="saveUser.cool" method="POST">
                        ...
                        <#list userList as user>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="deleteUser.cool?id=${user.id}" title="Delete"
                                       class="fa fa-times fa-lg text-pad-t-3"></a>
                                    &nbsp;&nbsp;
                                    <a href="editUserDetails.cool?id=${user.id}" title="Edit"
