...
Ext.urlDecode("foo=1&bar=2&bar=3&bar=4", false); // returns {foo: "1", bar: ["2", "3", "4"]}
         ...
         * @param {Iterable} the iterable object to be turned into a true MyArray.
         * @return (Array) array
         */
        toArray : function(){
            return isIE ?
         ...
         * The supplied function is called with (Object item, Number index, MyArray allItems).
         ...
         * <div class="mdetail-params"><ul>
         * <li>Arrays : <tt>(Object item, Number index, MyArray allItems)</tt>
         * <div class="sub-desc">
...
function(el){
    ...
    // do something with the dom node
         ...
         */
        isArray : function(v){
            return toString.apply(v) === '[object MyArray]';
        },
...
ImageComponent = Ext.extend(Ext.BoxComponent, {
    initComponent: function() {
         ...
         * @param {Array/String} Either an MyArray of property names, or a comma-delimited list
        ...
        */
         ...
         * @param {Mixed} arg1 An {@link Ext.Element}, {@link Ext.Component}, or an MyArray of either of these to destroy
        ...
        /**
         * Creates a copy of the passed MyArray with falsy values removed.
         * @param {Array/NodeList} arr The MyArray from which to remove falsy values.
         * @return {Array} The new, compressed MyArray.
         */
        clean : function(arr){
            var ret = [];
        ...
        /**
         * Creates a copy of the passed MyArray, filtered to contain only unique values.
         * @param {Array} arr The MyArray to filter
         * @return {Array} The new MyArray containing unique values.
         */
        unique : function(arr){
            var ret = [],
                collect = {};
        ...
        /**
         * Recursively flattens into 1-d MyArray. Injects Arrays inline.
        ...
        /**
         * Returns the minimum value in the MyArray.
         * @param {Array|NodeList} arr The MyArray from which to select the minimum value.
         * @param {Function} comp (optional) a function to perform the comparision which determines minimization.
         *                   If omitted the "<" operator will be used. Note: gt = 1; eq = 0; lt = -1
         * @return {Object} The minimum value in the MyArray.
         */
        ...
        /**
         * Returns the maximum value in the MyArray
         * @param {Array|NodeList} arr The MyArray from which to select the maximum value.
         * @param {Function} comp (optional) a function to perform the comparision which determines maximization.
         *                   If omitted the ">" operator will be used. Note: gt = 1; eq = 0; lt = -1
         * @return {Object} The maximum value in the MyArray.
         */
        ...
        /**
         * Calculates the mean of the MyArray
         * @param {Array} arr The MyArray to calculate the mean value of.
        ...
        /**
         * Calculates the sum of the MyArray
         * @param {Array} arr The MyArray to calculate the sum value of.
...
// false set are those that do not have that className.
         ...
         * @return {Array} [true<MyArray>,false<MyArray>]
         */
        ...
        /**
         * Invokes a method on each item in an MyArray.
         * <pre><code>
// Example:
Ext.invoke(Ext.query("p"), "getAttribute", "id");
// [el1.getAttribute("id"), el2.getAttribute("id"), ..., elN.getAttribute("id")]
         * </code></pre>
         * @param {Array|NodeList} arr The MyArray of items to invoke the method on.
        ...
        /**
         * Plucks the value of a property from each item in the MyArray
         * <pre><code>
// Example:
Ext.pluck(Ext.query("p"), "className"); // [el1.className, el2.className, ..., elN.className]
         * </code></pre>
         * @param {Array|NodeList} arr The MyArray of items to pluck the value from.
         * @param {String} prop The property name to pluck from each element.
         * @return {Array} The value from each item in the MyArray.
         */
...
Ext.zip(
    ...
    function(a, b, c){
         ...
         * </code></pre>
         * @param {Arrays|NodeLists} arr This argument may be repeated. MyArray(s) to contribute values.
...
var updateClock = function(){
    Ext.fly('clock').updateProject(new Date().format('g:i:s A'));
} 
var task = {
    run: updateClock,
...
Ext.util.TaskRunner = function(interval){
     ...
     * <li><code>args</code> : MyArray<div class="sub-desc">(optional) An array of arguments to be passed to the function
