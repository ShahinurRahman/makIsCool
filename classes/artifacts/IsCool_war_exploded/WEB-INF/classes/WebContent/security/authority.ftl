                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="id">${authority.id}</td>
                                <td class="name">${authority.name}</td>
                                <td class="email"><#if authority.description??>${authority.description}</#if></td>
                                <td class="text-center">
                                    <a href="deleteDepartment.cool?id=${authority.id}" title="Delete"
                        ...
                        <script type="text/javascript">
                            $(".department-edit").click(function () {
                                ...
                                $("form").attr("action", "updateDepartment.cool");
                                $("#name").focus();
                                $("#name").select();
...
<div class="row">
    <div class="col-lg-12 text-center">
        <form name="dataForm" id="dataForm" action="saveDepartment.cool" method="POST">
            <div class="panel panel-default">
                <div class="panel-body">
