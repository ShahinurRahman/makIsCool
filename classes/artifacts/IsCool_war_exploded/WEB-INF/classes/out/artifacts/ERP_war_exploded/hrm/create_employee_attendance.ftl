...
<@layout.gen_app_layout "${PageTitle}" >
    ...
    <div class="bread_crumbs_ui_div" style="width: 500px">
        <ul id="crumbs_ui_custom">
            ...
            <li><a href="attendanceList.cool">Attendance List</a></li>
    ...
    <div class="widget" style="width: 500px">
        ...
        <div id="user_crate" class="content" role="main" style="width: 450px;">
            ...
            <form name="saveEmployeeAttendanceForm" id="saveEmployeeAttendanceForm" action="saveEmployeeAttendance.cool" method="POST">
