...
<div class="widget" style="width: 500px">
    ...
    <div id="section_crate" class="content" role="main" style="width: 450px;">

        <form name="sectionForm" id="sectionForm" action="saveUser.cool" method="POST">
            ...
            <fieldset class="form">
                ...
                <div class="container_16">
                    ...
                    <div class="grid_4 omega reset-input reset-button-left">
                        <a id="organizationCreate" class="button icon approve" onclick="submitForm()">Save</a>
