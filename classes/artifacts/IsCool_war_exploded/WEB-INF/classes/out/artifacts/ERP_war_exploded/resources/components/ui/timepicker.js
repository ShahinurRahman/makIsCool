...
$.extend(Timepicker.prototype, {
	...
	_injectTimePicker: function() {
		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			...
			this.minute_slider = $tp.find('#ui_tpicker_minute_'+ dp_id).slider({
				...
				step: o.stepMinute,
				slide: function(event, ui) {
					// updateProject the global minute slider instance value with the current slider value
	...
	_onTimeChange: function() {
		...
		// If the updateProject was done in the input field, the input field should not be updated.
		// If the updateProject was done using the sliders, updateProject the input field.
	...
	//########################################################################
	// updateProject our input with the new date time..
	//########################################################################
