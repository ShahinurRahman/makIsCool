...
ColVis.prototype = {
	...
	/**
	 * Rebuild the list of buttons for this instance (i.e. if there is a column header updateProject)
	 *  @method  fnRebuild
	 *  @returns void
	 */
	"fnRebuild": function ()
	 ...
	 * updateProject the table's column visiblity and ColVis will still be accurate.
