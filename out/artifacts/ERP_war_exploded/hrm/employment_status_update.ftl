...
<div class="bread_crumbs_ui_div" style="width: 500px">
    <ul id="crumbs_ui_custom">
        ...
        <li><a href="employmentStatusList.cool">Status List</a></li>
        <li>Update Status</li>
    </ul>
</div>
<br class="clear"/>
...
<div class="widget" style="width: 500px">
    ...
    <div id="user_crate" class="content" role="main" style="width: 450px;">
        ...
        <form name="userForm" id="userForm" action="updateEmploymentStatus.cool" method="POST">
            ...
            <fieldset class="form">
                ...
                <div class="container_16">
                    ...
                    <div class="grid_4 omega reset-input">
                        <input type="statusName" name="statusName" id="statusName" value="${statusName}"/>
                    </div>
                    ...
                    <div class="grid_4 omega reset-input">
                        <input type="text" name="statusDescription" id="statusDescription" value="${statusDescription}"/>
                    </div>
