...
<div class="bread_crumbs_ui_div" style="width: 663px">
    <ul id="crumbs_ui_custom">
        ...
        <li><a href="recruitHome.cool">Recruitment Home</a></li>
        ...
        <form name="userForm" id="userForm" action="saveUser.cool" method="POST">
            ...
            <fieldset class="form">
                ...
                <div class="container_16">
                    ...
                    <div class="grid_4 omega reset-input">
                        <input type="text" name="noOfEmployees" id="noOfEmployees"/>
                    </div>
                    ...
                    <div class="grid_4 omega reset-input" id="responsibilityGroup" style="width: 315px;">
                        ...
                        <input type="text" name="responsibility1" id="responsibility1"/>
                        <img src="../resources/images/responsibility.png" id="responsibility" class="adjustImg" alt="" title="Select Responsibility">
                        <img src="../resources/images/add_32.png" id="addResponsibility" class="adjustImg" alt=""title="Add Responsibility">
                        <img src="../resources/images/minus_32.png" id="removeRequirement" class="adjustImg"  alt="" title="Remove Responsibility">
