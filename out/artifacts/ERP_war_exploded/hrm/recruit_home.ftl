...
<div class="widget" style="width: 849px">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 799px;">
        <ul class="widgetlist">
            ...
            <li><a href="createJobPosting.cool"><img src="../resources/images/recruit/post_jobs.png"><span>Job Posting</span></a></li>
            <li><a href="responsibilityList.cool"><img src="../resources/images/recruit/responsibility_48.png"><span>Responsibility</span></a></li>
            <li></li>
        </ul>
    </div>
