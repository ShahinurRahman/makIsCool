...
<div class="widget" style="width: 849px">
    ...
    <div id="recruit_home" class="content scaffold-list" role="main" style="width: 799px;">
        <ul class="widgetlist">
            ...
            <li><a href="createJobTitle.cool"><img src="../resources/images/jobtitles.png"><span>Job Title</span></a></li>
            <li><a href="createJobRole.cool"><img src="../resources/images/job_role.png"><span>Job Role</span></a></li>
            <li><a href="createJobSpec.cool"><img src="../resources/images/job_space.png"><span>Job Spec</span></a></li>
            <li><a href="createEmployeeStatus.cool"><img src="../resources/images/status.png"><span>Job Status</span></a></li>
            <li></li>
            <li></li>
        </ul>
    </div>
