...
<div class="widget" style="width: 500px">
    ...
    <div id="jobRole_crate" class="content" role="main" style="width: 450px;">
        ...
        <form name="jobRoleForm" id="jobRoleForm" action="saveUser.cool" method="POST">
            ...
            <fieldset class="form">
                ...
                <div class="container_16">
                    ...
                    <div class="grid_4 omega reset-input reset-button-left">
                        ...
                        <a id="ff" class="button danger icon remove" onclick="document.jobRoleDescriptionForm.reset()">Clear</a>
                    </div>
    ...
    <script type="text/javascript">
        function submitForm(){
            document.jobRoleDescriptionForm.submit();
            alert(1)
        }
    </script>
</div>
